...
app.controller('homeCtrl',['$scope','$filter',function(scope,filter){
    ...
    'Childrens attachment (see attachment difficulties in children and young people)',
    'Childrens palliative care, for people with life-limiting conditions (see end of life care for people with life-limiting conditions)',
    ...
    'Inflammatory bowel disease (see Crohns disease)',
    ...
    'Social care services, peoples experience',
